...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        private string containerId2 = "box";
        ...
        private async Task CreateContainerAsync()
        {
            ...
            this.container2 = await this.database.CreateContainerIfNotExistsAsync(containerId2, "/LastNameBox", 400);
        ...
        private async Task AddItemsToContainerAsync()
        {
            ...
            try
            {
                andersenFamily.Id = Guid.NewGuid().ToString();
        ...
        private async Task QueryItemsAsync()
        {
            ...
            System.Linq.IOrderedQueryable<Family> s = this.container.GetItemLinqQueryable<Family>(true);
            /*
            var list = from family in s
                       where family.Name.Contains("a")
                       select family;
            */
        }
        // </QueryItemsAsync>
